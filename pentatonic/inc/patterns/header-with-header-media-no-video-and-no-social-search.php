...
<!-- wp:heading {"textColor":"foreground","fontSize":"huge-display","style":{"typography":{"lineHeight":"1.2"}}} -->
<h2 class="has-foreground-color has-text-color has-huge-display-font-size" style="line-height:1.2">' . esc_html__( 'Rock Music Podcast', 'pentatonic' ) . '</h2>
<!-- /wp:heading -->
